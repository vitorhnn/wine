...
} __attribute__((packed)) IDEREGS, *PIDEREGS, *LPIDEREGS;
...
} __attribute__((packed)) SENDCMDINPARAMS, *PSENDCMDINPARAMS, *LPSENDCMDINPARAMS;
...
} __attribute__((packed)) DRIVERSTATUS, *PDRIVERSTATUS, *LPDRIVERSTATUS;
...
} __attribute__((packed)) SENDCMDOUTPARAMS, *PSENDCMDOUTPARAMS, *LPSENDCMDOUTPARAMS;
...
typedef struct _IDENTIFY_DEVICE_DATA {
  ...
  USHORT Signature : 8;
  USHORT CheckSum : 8;
} __attribute__((packed)) IDENTIFY_DEVICE_DATA, *PIDENTIFY_DEVICE_DATA;
